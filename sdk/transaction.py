...
class Transaction:
    def __init__(self, **kwargs):
        ...
        self.kwargs = kwargs
        self.expiration = (datetime.datetime.utcnow() + datetime.timedelta(seconds=30)).strftime("%Y-%m-%dT%H:%M:%S")
        self.actions = []
    ...
    def dumps(self):
        ...
        self.signatures = [priv_key.sign_hash(digest).to_string() for priv_key in self.priv_keys]
        ret = {
