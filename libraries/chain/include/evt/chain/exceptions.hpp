...
FC_DECLARE_DERIVED_EXCEPTION( delay_not_existed_exception,        action_exception, 3040007, "Delay does not exist." );
...
FC_DECLARE_DERIVED_EXCEPTION( delay_exists_exception,             action_exception, 3040012, "Delay already exists." );
...
FC_DECLARE_DERIVED_EXCEPTION( delay_status_exception,             action_exception, 3040027, "Delay is not in proper status." );
FC_DECLARE_DERIVED_EXCEPTION( delay_proposer_key_exception,       action_exception, 3040028, "Proposer needs to sign his key." );
FC_DECLARE_DERIVED_EXCEPTION( delay_duplicate_key_exception,      action_exception, 3040029, "Some keys are already signed this delay trx." );
FC_DECLARE_DERIVED_EXCEPTION( delay_expired_tx_exception,         action_exception, 3040030, "Delay transaction is expired." );
FC_DECLARE_DERIVED_EXCEPTION( delay_not_required_keys_exception,  action_exception, 3040031, "Provided keys are not required." );
FC_DECLARE_DERIVED_EXCEPTION( delay_executor_exception,           action_exception, 3040032, "Invalid executor." );
FC_DECLARE_DERIVED_EXCEPTION( delay_invalid_action_exception,     action_exception, 3040033, "Action is not valid for delay transaction." );
