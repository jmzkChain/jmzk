...
FC_DECLARE_DERIVED_EXCEPTION( staking_days_exception,        staking_exception, 3041105, "Invalid staking days exception" );
FC_DECLARE_DERIVED_EXCEPTION( staking_units_exception,       staking_exception, 3041106, "Invalid staking units exception" );
FC_DECLARE_DERIVED_EXCEPTION( staking_not_enough_exception,  staking_exception, 3041107, "Not enough staking units exception" );
FC_DECLARE_DERIVED_EXCEPTION( staking_symbol_exception,      staking_exception, 3041107, "Invalid staking asset symbol exception" );
FC_DECLARE_DERIVED_EXCEPTION( staking_status_exception,      staking_exception, 3041108, "Invalid staking status exception" );
FC_DECLARE_DERIVED_EXCEPTION( staking_active_exception,      staking_exception, 3041109, "Cannot active shares exception" );
FC_DECLARE_DERIVED_EXCEPTION( stakepool_duplicate_exception, staking_exception, 3041110, "Duplicate stakepool exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_stakepool_exception,   staking_exception, 3041111, "Unknown stakepool exception" );
