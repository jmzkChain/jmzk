...
FC_DECLARE_DERIVED_EXCEPTION( domain_exception,           action_exception, 3210000, "Domain exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_domain_exception,   domain_exception, 3210001, "Domain does not exist." );
FC_DECLARE_DERIVED_EXCEPTION( domain_duplicate_exception, domain_exception, 3210002, "Domain already exists." );
FC_DECLARE_DERIVED_EXCEPTION( domain_name_exception,      domain_exception, 3210003, "Invalid domain name" );

FC_DECLARE_DERIVED_EXCEPTION( token_exception,                action_exception, 3220000, "Token exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_token_exception,        token_exception,  3220001, "Token does not exist." );
FC_DECLARE_DERIVED_EXCEPTION( token_duplicate_exception,      token_exception,  3220002, "Token already exists." );
FC_DECLARE_DERIVED_EXCEPTION( token_name_exception,           token_exception,  3220003, "Invalid token name" );
FC_DECLARE_DERIVED_EXCEPTION( token_owner_exception,          token_exception,  3220004, "Token owner cannot be empty." );
FC_DECLARE_DERIVED_EXCEPTION( token_destroyed_exception,      token_exception,  3220005, "Token is destroyed." );
FC_DECLARE_DERIVED_EXCEPTION( token_locked_exception,         token_exception,  3220006, "Locked token cannot be transfered." );
FC_DECLARE_DERIVED_EXCEPTION( token_cannot_destroy_exception, token_exception,  3220007, "Token in this domain cannot be destroyed." );

FC_DECLARE_DERIVED_EXCEPTION( group_exception,           action_exception, 3230000, "Group exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_group_exception,   group_exception,  3230001, "Group does not exist." );
FC_DECLARE_DERIVED_EXCEPTION( group_duplicate_exception, group_exception,  3230002, "Group already exists." );
FC_DECLARE_DERIVED_EXCEPTION( group_name_exception,      group_exception,  3230003, "Invalid group name" );
FC_DECLARE_DERIVED_EXCEPTION( group_key_exception,       group_exception,  3230004, "Group key is reserved to update this group." );

FC_DECLARE_DERIVED_EXCEPTION( fungible_exception,           action_exception,   3240000, "Fungible exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_fungible_exception,   fungible_exception, 3240001, "Fungible asset does not exist." );
FC_DECLARE_DERIVED_EXCEPTION( fungible_duplicate_exception, fungible_exception, 3240002, "Fungible asset already exists." );
FC_DECLARE_DERIVED_EXCEPTION( fungible_name_exception,      fungible_exception, 3240003, "Invalid fungible asset name" );
FC_DECLARE_DERIVED_EXCEPTION( fungible_symbol_exception,    fungible_exception, 3240004, "Invalid fungible asset symbol" );
FC_DECLARE_DERIVED_EXCEPTION( fungible_supply_exception,    fungible_exception, 3240005, "Invalid fungible supply" );
FC_DECLARE_DERIVED_EXCEPTION( fungible_address_exception,   fungible_exception, 3240006, "Invalid address" );
FC_DECLARE_DERIVED_EXCEPTION( math_overflow_exception,      fungible_exception, 3240007, "Operations resulted in overflow." );
FC_DECLARE_DERIVED_EXCEPTION( balance_exception,            fungible_exception, 3240008, "Not enough balance left." );

FC_DECLARE_DERIVED_EXCEPTION( suspend_exception,                   action_exception,  3250000, "Suspend exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_suspend_exception,           suspend_exception, 3250001, "Suspend transaction does not exist." );
...
FC_DECLARE_DERIVED_EXCEPTION( suspend_invalid_action_exception,    suspend_exception, 3250009, "Action is not valid for suspend transaction." );
FC_DECLARE_DERIVED_EXCEPTION( proposal_name_exception,             suspend_exception, 3250010, "Invalid proposal name" );

FC_DECLARE_DERIVED_EXCEPTION( meta_exception,         action_exception, 3260000, "Meta exception" );
FC_DECLARE_DERIVED_EXCEPTION( meta_key_exception,     meta_exception,   3260001, "Invalid meta key" );
FC_DECLARE_DERIVED_EXCEPTION( meta_value_exception,   meta_exception,   3260002, "Invalid meta value" );
FC_DECLARE_DERIVED_EXCEPTION( meta_involve_exception, meta_exception,   3260003, "Creator is not involved." );

FC_DECLARE_DERIVED_EXCEPTION( evt_link_exception,            action_exception,   3270000, "EVT-Link exception" );
FC_DECLARE_DERIVED_EXCEPTION( evt_link_no_key_exception,     evt_link_exception, 3270001, "Specific segment key is not in this evt-link." );
FC_DECLARE_DERIVED_EXCEPTION( evt_link_version_exception,    evt_link_exception, 3270002, "EVT-Link version is not valid.");
FC_DECLARE_DERIVED_EXCEPTION( evt_link_id_exception,         evt_link_exception, 3270003, "EVT-Link id is not valid.");
FC_DECLARE_DERIVED_EXCEPTION( evt_link_dupe_exception,       evt_link_exception, 3270004, "Duplicate EVT-Link.");
FC_DECLARE_DERIVED_EXCEPTION( evt_link_type_exception,       evt_link_exception, 3270005, "Invalid EVT-Link type.");
FC_DECLARE_DERIVED_EXCEPTION( evt_link_expiration_exception, evt_link_exception, 3270006, "EVT-Link is expired.");
FC_DECLARE_DERIVED_EXCEPTION( evt_link_existed_exception,    evt_link_exception, 3270007, "EVT-Link is not existed.");
FC_DECLARE_DERIVED_EXCEPTION( everipass_exception,           evt_link_exception, 3270008, "everiPass failed.");
FC_DECLARE_DERIVED_EXCEPTION( everipay_exception,            evt_link_exception, 3270009, "everiPay failed.");

FC_DECLARE_DERIVED_EXCEPTION( prodvote_exception,          action_exception,   3280000, "Producer vote exception" );
FC_DECLARE_DERIVED_EXCEPTION( prodvote_key_exception,      prodvote_exception, 3280001, "Unknown prodvote conf key.");
FC_DECLARE_DERIVED_EXCEPTION( prodvote_value_exception,    prodvote_exception, 3280002, "Invalid prodvote conf value.");
FC_DECLARE_DERIVED_EXCEPTION( prodvote_producer_exception, prodvote_exception, 3280003, "Invalid producer.");

FC_DECLARE_DERIVED_EXCEPTION( lock_exception,               action_exception, 3290000, "Lock assets exception" );
FC_DECLARE_DERIVED_EXCEPTION( unknown_lock_exception,       lock_exception,   3290001, "Unknown lock assets proposal" );
FC_DECLARE_DERIVED_EXCEPTION( lock_duplicate_exception,     lock_exception,   3290002, "Lock assets proposal already exists." );
FC_DECLARE_DERIVED_EXCEPTION( lock_unlock_time_exception,   lock_exception,   3290003, "Invalid unlock time." );
FC_DECLARE_DERIVED_EXCEPTION( lock_deadline_exception,      lock_exception,   3290004, "Invalid deadline." );
FC_DECLARE_DERIVED_EXCEPTION( lock_assets_exception,        lock_exception,   3290005, "Invalid lock assets." );
FC_DECLARE_DERIVED_EXCEPTION( lock_address_exception,       lock_exception,   3290006, "Invalid lock address." );
FC_DECLARE_DERIVED_EXCEPTION( lock_condition_exception,     lock_exception,   3290007, "Invalid lock condition." );
FC_DECLARE_DERIVED_EXCEPTION( lock_expired_exception,       lock_exception,   3290008, "Lock assets proposal is expired." );
FC_DECLARE_DERIVED_EXCEPTION( lock_aprv_data_exception,     lock_exception,   3290009, "Approve data is not valid." );
FC_DECLARE_DERIVED_EXCEPTION( lock_duplicate_key_exception, lock_exception,   3290010, "Some keys are already signed this lock assets proposal." );
FC_DECLARE_DERIVED_EXCEPTION( lock_not_reach_unlock_time,   lock_exception,   3290011, "Unlock time is not reach." );
FC_DECLARE_DERIVED_EXCEPTION( lock_not_reach_deadline,      lock_exception,   3290012, "Deadline is not reach." );
