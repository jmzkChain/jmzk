...
CHAINBASE_SET_INDEX_TYPE(evt::chain::dynamic_global_property_object,
                         evt::chain::dynamic_global_property_multi_index)

FC_REFLECT(evt::chain::dynamic_global_property_object,
           (head_block_number)
           (head_block_id)
           (time)
           (current_producer)
...
FC_REFLECT(evt::chain::global_property_object,
           (configuration)
           (active_producers)
          )
