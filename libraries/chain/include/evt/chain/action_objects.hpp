...
CHAINBASE_SET_INDEX_TYPE(evt::chain::action_permission_object, evt::chain::action_permission_index)

FC_REFLECT(evt::chain::action_permission_object, (id)(owner)(owner_permission)(scope_permission) )
