...
FC_REFLECT(evt::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(evt::chain::key_weight, (key)(weight) )
FC_REFLECT(evt::chain::authority, (threshold)(keys)(accounts))
FC_REFLECT(evt::chain::shared_authority, (threshold)(keys)(accounts))
