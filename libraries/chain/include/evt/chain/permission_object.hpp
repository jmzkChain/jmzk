...
CHAINBASE_SET_INDEX_TYPE(evt::chain::permission_object, evt::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(evt::chain::permission_usage_object, evt::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<evt::chain::permission_object>, (_id))
FC_REFLECT(evt::chain::permission_object, (id)(owner)(parent)(name)(auth))

FC_REFLECT(chainbase::oid<evt::chain::permission_usage_object>, (_id))
FC_REFLECT(evt::chain::permission_usage_object, (id)(account)(permission)(last_used))
