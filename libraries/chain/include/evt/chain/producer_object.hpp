...
CHAINBASE_SET_INDEX_TYPE(evt::chain::producer_object, evt::chain::producer_multi_index)

FC_REFLECT(evt::chain::producer_object::id_type, (_id))
FC_REFLECT(evt::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
