...
CHAINBASE_SET_INDEX_TYPE(evt::chain::bandwidth_usage_object, evt::chain::bandwidth_usage_index)
CHAINBASE_SET_INDEX_TYPE(evt::chain::compute_usage_object, evt::chain::compute_usage_index)
