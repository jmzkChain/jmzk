...
CHAINBASE_SET_INDEX_TYPE(evt::chain::permission_link_object, evt::chain::permission_link_index)

FC_REFLECT(evt::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
