...
{ try {
   ...
   ilog( "push block #${n} from ${pro} ${time}  ${id} lib: ${l} success", ("n",new_block.block_num())("pro",(std::string)new_block.producer)("time",new_block.timestamp)("id",new_block.id())("l",last_irreversible_block_num()));
...
{ try {
   ...
   wlog( "pop block #${n} from ${pro} ${time}  ${id}", ("n",head_block->block_num())("pro",(std::string)head_block->producer)("time",head_block->timestamp)("id",head_block->id()));
