...
void
unpack(Stream& s, fc::crypto::r1::public_key& pk) {
...
template<typename Stream>
void
pack(Stream& s, const fc::crypto::r1::public_key& pk) {
    fc::raw::pack(s, pk.serialize());
}

template<typename Stream>
void
unpack(Stream& s, fc::crypto::r1::private_key& pk) {
    fc::sha256 sec;
    unpack(s, sec);
...
template<typename Stream>
void
pack(Stream& s, const fc::crypto::r1::private_key& pk) {
