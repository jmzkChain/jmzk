...
RUN echo 'APT::Install-Recommends 0;' >> /etc/apt/apt.conf.d/01norecommends \
    ...
    && apt-get update \
    && apt-get install -y wget python3 python3-dev build-essential python3-pip python3-setuptools python3-wheel openssl libssl1.1 llvm-7 --no-install-recommends \
