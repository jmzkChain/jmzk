...
If you are currently using 'clevt push action' command, try to add the relevant authority using -p option.)=====";
...
const char* error_advice_3030011 =  "You can try embedding evt nonce action inside your transaction to ensure uniqueness.";
...
You can check the contract's abi by using 'clevt get code' command.)=====";
...
const char* error_advice_3120002 = R"=====(Public key should be encoded in base58 and starts with EVT prefix)=====";
...
{
  "threshold":"1",
  "keys":[{ "key":"EVT6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"1" }],
  "accounts":[{
...
e.g.
{
  "signatures" : [ "EVTJze4m1ZHQ4UjuHpBcX6uHPN4Xyggv52raQMTBZJghzDLepaPcSGCNYTxaP2NiaF4yRF5RaYwqsQYAwBwFtfuTJr34Z5GJX" ],
  "compression" : "none",
...
const char* error_advice_3130001 =  "Ensure that you have \033[2mevt::chain_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_3130002 =  "Ensure that you have \033[2mevt::wallet_api_plugin\033[0m\033[32m added to your node's configuration!\n"\
...
const char* error_advice_3130003 =  "Ensure that you have \033[2mevt::account_history_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_3130004 =  "Ensure that you have \033[2mevt::net_api_plugin\033[0m\033[32m added to your node's configuration!";
