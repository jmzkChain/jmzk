...
@click.option("--evtd_dir",help="the data directory of the evtd",type=click.Path,default="/home/harry/evtd_data")
@click.option("--mongo_db_dir",help="the data directory of the mongodb",type=type=click.Path,default="/home/harry/mongo_db_data")
...
def create(enable_mongodb,producer_number,nodes_number,evtd_port_http,evtd_port_p2p,mongo_db_port,evtd_dir,mongo_db_dir,use_tmpfs,tmpfs_size):
    ...
    if(enable_mongodb):
        ...
        for i in range(0,nodes_number):
            ...
            network="evt-net",
            hostname="127.0.0.1",
            ports={str(mongo_db_port+i):27017+i},
            detach=True,
            volumes={file:{'bind':'/data/dbd','mode':'rw'}}
            )
        time.sleep(5)
    ...
    for i in range(0,nodes_number):
        ...
        if(enable_mongodb):
            command+=" --plugin=evt::mongo_db_plugin --mongodb-uri=mongodb://"+"mongodb_"+str(i)+":"+str(27017+i)
...
@click.option("--evtd_dir",help="the data directory of the evtd",type=click.Path,default="/home/harry/evtd_data")
@click.option("--mongo_db_dir",help="the data directory of the mongodb",type=click.Path,default="/home/harry/mongo_db_data")
